...
export function LostPetForm({ mapsApiKey }: LostPetFormProps) {
		...
		return (
			<div className="rounded-xl bg-emerald-500/10 p-8 text-center">
				...
				<p className="text-gray-300">
					Redirecting to your pet's listing page...
				</p>
			</div>
		);
	}
	...
	return (
		...
		>
			...
			{/* Pet Information */}
			<div>
				<h2 className="mb-6 text-2xl font-semibold text-rose-400">
					Pet Information
				</h2>
				<div className="grid gap-6">
					<div>
						<label htmlFor="petName" className="mb-2 block font-medium">
							Pet's Name
						</label>
						<input
							id="petName"
					...
					<div className="grid gap-6 sm:grid-cols-2">
						<div>
							<label htmlFor="petType" className="mb-2 block font-medium">
								Type of Pet
							</label>
							<select
								id="petType"
						...
						<div>
							<label htmlFor="petBreed" className="mb-2 block font-medium">
								Breed
							</label>
							<input
								id="petBreed"
					...
					<div>
						<label htmlFor="petPhoto" className="mb-2 block font-medium">
							Upload Photo
						</label>
						<input
							id="petPhoto"
				...
				<div className="grid gap-6">
					<div>
						...
						<p className="mt-2 text-sm text-gray-400">
							For privacy, we only store the coordinates of this location, not
							the address.
						</p>
					</div>
					...
					<div>
						<label htmlFor="lastSeenDate" className="mb-2 block font-medium">
							Date Last Seen
						</label>
						<input
							id="lastSeenDate"
