...
export function Pet({ ctx, params }: RequestInfo) {
	...
	const pet = {
		...
		date: "2024-03-15",
		description:
			"Luna is a friendly Golden Retriever who loves people. She was last seen near the lake in Central Park wearing a red collar with tags.",
		contact: {
			name: "John Smith",
			phone: "(555) 123-4567",
					...
					<div className="space-y-6">
						...
						<div className="rounded-lg bg-white/5 p-6">
							...
							<div className="space-y-2 text-gray-300">
								...
								<p>
									<strong>Missing Since:</strong> {pet.date}
								</p>
							</div>
						</div>
						...
						<div className="rounded-lg bg-emerald-600/20 p-6">
							...
							<div className="space-y-2 text-gray-300">
								<p>
									<strong>Name:</strong> {pet.contact.name}
								</p>
								<p>
						...
						<div className="flex gap-4">
							<button
								type="button"
								className="flex-1 rounded-lg bg-emerald-600 px-6 py-3 font-semibold text-white hover:bg-emerald-700 transition-colors"
							>
								Report Sighting
							</button>
							<button
								type="button"
								className="flex-1 rounded-lg bg-rose-600 px-6 py-3 font-semibold text-white hover:bg-rose-700 transition-colors"
							>
								Share
							</button>
						</div>
