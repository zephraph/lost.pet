						...
						<div className="grid gap-8 md:grid-cols-2">
							<div className="rounded-lg bg-white/5 p-8">
								...
								<p className="mb-4 text-gray-300">
									Join our network of dedicated volunteers who help reunite pets
									with their families. You can help by:
								</p>
					...
					<section>
						...
						<div className="rounded-lg bg-white/5 p-8">
							<p className="mb-6 text-gray-300">
								Are you a veterinary clinic, animal shelter, or pet-related
								business? Partner with us to expand our network and help more
