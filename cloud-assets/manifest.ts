import type { ResizeOptions, JpegOptions } from "sharp";
...
const manifest: CloudAssetManifest =   {
    "homepage-bg.jpg": {
      ...
      "source": "https://unsplash.com/photos/a-dog-that-is-sitting-down-in-the-sand-Xlu7M8OtW6o",
      "variants": [
        {
          "name": "offset",
          "transform": {
    ...
    "404-bg.jpg": {
      ...
      "source": "https://unsplash.com/photos/brown-long-coat-small-dog-walking-on-street-during-daytime-NCArqzab0AI",
      "variants": []
    },
